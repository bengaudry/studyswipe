                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div
                                    className={`w-8 h-8 aspect-square bg-${deck.theme}-500 bg-opacity-50 dark:hover:bg-opacity-70 rounded-lg`}
                                />
